...
abstract class Kernel
{
    ...
    public function __construct()
    {
        ...
        {
            $sModRewriteMsg = '<span style="font-weight:bold;color:red">At the moment, pH7CMS still requires Apache "mod_rewrite". Please install it so pH7CMS can works.<br /> Click <a href="http://software.hizup.com/doc/en/how-to-install-rewrite-module" target="_blank">here</a> if you want to get more information on how to install the rewrite module.</span>';
